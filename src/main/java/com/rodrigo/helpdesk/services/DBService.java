...
public class DBService {
    ...
    public void instanciaDB() {
        ...
        Chamado cham1 = new Chamado(null, Prioridade.MEDIA, Status.ANDAMENTO, "Título chamado 1",
                "Observações chamado 1", cli1, tec1);
        Chamado cham2 = new Chamado(null, Prioridade.ALTA, Status.ABERTO, "Título chamado 2", "Observações chamado 2",
                cli2, tec1);
        Chamado cham3 = new Chamado(null, Prioridade.BAIXA, Status.ENCERRADO, "Título chamado 3",
                "Observações chamado 3", cli3, tec2);
        Chamado cham4 = new Chamado(null, Prioridade.ALTA, Status.ABERTO, "Título chamado 4", "Observações chamado 4",
                cli3, tec3);
        Chamado cham5 = new Chamado(null, Prioridade.MEDIA, Status.ANDAMENTO, "Título chamado 5",
                "Observações chamado 5", cli1, tec2);
        Chamado cham6 = new Chamado(null, Prioridade.BAIXA, Status.ENCERRADO, "Título chamado 6",
                "Observações chamado 6", cli2, tec1);
